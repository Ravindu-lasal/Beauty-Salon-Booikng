<?php
    ...
    if (isset($_GET['confirmid'])) {
        ...
        if ($conn->query($update_sql) === TRUE) {
            echo '<script>alert("Appointment confirmed successfully!"); window.location.href="appointment_pending.php";</script>';
        }
        else {
    ...
    if (isset($_GET['canceledid'])) {
        ...
        if ($conn->query($update_sql) === TRUE) {
            ...
            header("Location: appointment_pending.php?msg=appointment_cancelled");
            exit();
        }    else {
