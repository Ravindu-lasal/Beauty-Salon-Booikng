                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="text-center d-flex flex-nowrap gap-2 justify-content-center">
                                                ...
                                                elseif ($row['status'] == 'confirmed') {
                                                    echo '<a href="appointment.php?completeid=' . $row['appointment_id'] . '" class="btn btn-info btn-sm" onclick="return confirm(\'Are you sure you want to complete this appointment?\')"><i class="fas fa-clipboard-check"></i> Complete</a>';
                                                }
                                                elseif ($row['status'] == 'cancelled') {
                                                    echo '<button class="btn btn-secondary btn-sm" disabled><i class="fas fa-file-invoice"></i></button>';
                                                }
                                                elseif ($row['status'] == 'completed') {
                                                    echo '<a href="billing.php?billingid=' . $row['appointment_id'] . '" class="btn btn-primary btn-sm"><i class="fas fa-file-invoice-dollar"></i> Invoice</a>';
                                                }
                                                ?>
                                                <a class="btn btn-danger btn-sm px-3" href="appointment_cancelled.php?deleteid=<?php echo $row['appointment_id'] ?>">
